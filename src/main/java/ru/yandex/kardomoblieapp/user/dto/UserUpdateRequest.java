...
public class UserUpdateRequest {
    ...
    @Pattern(regexp = "^[^!@#$%^&09]+$", message = "Имя не может быть пустым и должно содержать от 2 до 20 символов.")
    ...
    @Pattern(regexp = "^[^!@#$%^&09]+$", message = "Фамилия не может быть пустой и должно содержать от 2 до 20 символов.")
