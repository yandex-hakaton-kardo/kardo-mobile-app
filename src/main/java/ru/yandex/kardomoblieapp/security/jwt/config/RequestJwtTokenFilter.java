...
public class RequestJwtTokenFilter extends OncePerRequestFilter {
    ...
    private TokenSerializer<String> refreshTokenStringSerializer = Objects::toString;

    private TokenSerializer<String> accessTokenStringSerializer = Objects::toString;
